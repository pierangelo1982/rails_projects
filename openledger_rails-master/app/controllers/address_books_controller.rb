class AddressBooksController < ApplicationController
  ...
  def new
    ...
    @address_book.address_book_banks.build
  end
  ...
  private
    ...
    def address_book_params
      params.require(:address_book).permit(:name, :vat, :tax_code, :address, :address_nr, :zip, :city, :country, :phone, :fax, :email, :web, :note, :customer, :supplier,
                      address_book_banks_attributes: [:id, :name, :abi, :cab, :iban, :note, :_destroy])
    end
end
