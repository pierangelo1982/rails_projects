...
class BanksControllerTest < ActionController::TestCase
  ...
  test "should create bank" do
    assert_difference('Bank.count') do
      post :create, bank: { abi: @bank.abi, azienda_id: @bank.azienda_id, cab: @bank.cab, iban: @bank.iban, nome: @bank.nome, numeroconto: @bank.numeroconto }
    end
  ...
  test "should update bank" do
    patch :update, id: @bank, bank: { abi: @bank.abi, azienda_id: @bank.azienda_id, cab: @bank.cab, iban: @bank.iban, nome: @bank.nome, numeroconto: @bank.numeroconto }
    assert_redirected_to bank_path(assigns(:bank))
  end
