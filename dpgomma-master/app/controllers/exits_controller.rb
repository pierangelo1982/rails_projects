class ExitsController < ApplicationController
  ...
  private
    ...
    def exit_params
      params.require(:exit).permit(:azienda_id, :data, :numero, { entratum_ids:[] }, :colli, :quantita, :scarti, :netto, :tax, :totale, :note, :tipo_trasporto, :aspetto, :responsabile_trasporto, :altro, :consegnato)
    end
end
