...
class TaxesControllerTest < ActionController::TestCase
  ...
  test "should create tax" do
    assert_difference('Tax.count') do
      post :create, tax: { codice: @tax.codice, descrizione: @tax.descrizione, titolo: @tax.titolo, valore: @tax.valore }
    end
  ...
  test "should update tax" do
    patch :update, id: @tax, tax: { codice: @tax.codice, descrizione: @tax.descrizione, titolo: @tax.titolo, valore: @tax.valore }
    assert_redirected_to tax_path(assigns(:tax))
  end
