class CustumersController < ApplicationController
  ...
  private
    ...
    def custumer_params
      params.require(:custumer).permit(:denominazione, :nome, :cognome, :piva, :codfisc, :telefono, :fax, :email, :web, :indirizzo, :civico, :cap, :citta, :latitudine, :longitudine, :note, :image)
    end
end
